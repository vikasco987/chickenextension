  ...
  return (
    <>
      ...
      <div className={`mobile-bottom-nav mobile-only ${showBottomNav ? 'visible' : 'hidden'}`}>
        ...
        <a href="#" className="nav-btn btn-toing"><span className="toing-logo" style={{ fontSize: '14px', marginTop: '4px' }}>toing</span></a>
      </div>
